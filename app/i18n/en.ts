const en = {
  ...
  errorScreen: {
    title: "뭔가 잘못되었습니다!",
    friendlySubtitle:
      "이 화면은 오류가 발생할 때 프로덕션에서 사용자에게 표시됩니다. 이 메시지를 커스터마이징 할 수 있고(해당 파일은 `app/i18n/en.ts` 에 있습니다) 레이아웃도 마찬가지로 수정할 수 있습니다(`app/screens/error`). 만약 이 오류화면을 완전히 없에버리고 싶다면 `app/app.tsx` 파일에서 <ErrorBoundary> 컴포넌트를 확인하기 바랍니다.",
    reset: "초기화",
  ...
  authPhoneScreen: {
    authPhone: "휴대폰 인증",
    tapToSendCode: "인증번호 보내기",
    phoneFieldPlaceholder: "휴대폰번호를 입력하세요",
  },
  signUpScreen: {
    inputInfo: "정보입력",
    nickNameLabel: "닉네임",
    ...
    regionLabel: "지역",
    start: "시작하기",
    nickNamePlaceholder: "닉네임을 입력하세요 (8자 이하)",
  },
  loginScreen: {
    signIn: "로그인",
    enterDetails:
